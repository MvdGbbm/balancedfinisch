...
export function useAudioPlayback({
  ...
  const { validateAudioUrl, isStreamUrl, aacSupported } = useAudioValidation();
  ...
  }, [onEnded, volume, isLooping, toast, audioUrl, isRetrying, onError, isPlayingExternal, onPlayPauseChange, isLiveStream]);
  ...
  }, [isPlayingExternal, audioUrl, isPlaying]);
