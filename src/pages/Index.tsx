...
const Index = () => {
  ...
  return <MobileLayout>
      <section className="space-y-6 animate-fade-in">
        ...
        {currentQuote && <Card className="glass-morphism border overflow-hidden animate-scale-in">
        ...
        <div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4">
            {getRecentMeditations().map(meditation => <Card key={meditation.id} className="flex-shrink-0 w-40 overflow-hidden neo-morphism animate-slide-in" onClick={() => navigate("/meditations")}>
        ...
        <div className="grid grid-cols-2 gap-3">
          {features.map(feature => <Card key={feature.title} className={cn("overflow-hidden cursor-pointer neo-morphism hover:shadow-md transition-shadow duration-300 animate-scale-in")} onClick={() => navigate(feature.path)}>
              <CardContent className="p-4">
